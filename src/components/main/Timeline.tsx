...
export const timelineData: TimelineItem[] = [
  {
    ...
    location: 'Cotonou',
    imageURL: '/DISCOVERY-2025.png',
    date: 'Jan 2025 - Jan 2025',
    description: 'Contributed to the DISCOVERY 2025 program, an intensive one-week innovation challenge focused on designing a technology-driven solution to support African athletes in improving performance and training efficiency.',
    achievements: [
      "Understanding the reality experienced by beninese athletes",
      "Identify the problems they face daily in their quest for performance",
      "Brainstorming and proposing innovative solutions leveraging technology to address these challenges",
      "Collaborating with a multidisciplinary team to develop a concept for the proposed solution",
      "Presenting the solution to a panel of judges and receiving feedback for further development",
    ],
  ...
  },
  {
    ...
    description: "Completed a web development internship focused on frontend integration and UI implementation, working on web pages and applying best practices in code structure and version control within a professional environment.",
    achievements: [
    "Integrated user interfaces using HTML, CSS, and Bootstrap.",
    "Worked from design mockups to functional web pages.",
    "Applied version control using Git in a collaborative environment.",
    "Improved code organization and readability following project guidelines.",
    "Gained exposure to professional development workflows and deadlines."
],
