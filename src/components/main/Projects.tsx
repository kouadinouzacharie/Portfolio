...
const projectsData = [
  {
    title: 'my_pgp – Cryptography Toolkit',
    description: 'Command-line application that implements core encryption techniques((XOR, AES-128, RSA) to protect data(messages) and securely exchange keys, inspired by the PGP model.',
    imageURL: '/my_pgp.jpg',
    github: 'https://github.com/kouadinouzacharie',
    live: '',
    tags: ['C', 'Cryptography', 'AES', 'RSA', 'CLI']
  },
  {
  title: 'my_ftp – FTP Server',
  description: 'A secure network server that implements the File Transfer Protocol (FTP), allowing clients to connect, authenticate, and transfer files. The project focuses on socket programming, client–server communication, and handling multiple connections.',
  imageURL: '/my_ftp.png',
  github: 'https://github.com/kouadinouzacharie',
  live: '',
  tags: ['C++', 'Networking', 'Sockets', 'FTP', 'Server']
  },

  {
  title: 'AREA – Workflow Automation Platform',
  description: 'Web platform enabling users to automate tasks between multiple online services through trigger–action workflows. Developed the full backend architecture, including API integrations, event processing, and automation logic.',
  imageURL: '/area.png',
  github: 'https://github.com/kouadinouzacharie',
  live: '',
  tags: ['Database', 'Backend', 'APIs', 'Automation', 'Web']
  },
  {
  title: 'Chisel - Boot2Root Network Challenge',
  description: 'A Boot2Root challenge where participants must exploit a vulnerable server to gain root access. The project involves network reconnaissance, vulnerability analysis, and exploitation techniques to achieve the objective.',
  imageURL: '/chisel.jpg',
  github: 'https://github.com/kouadinouzacharie',
  live: '',
  tags: ['Cybersecurity', 'Boot2Root', 'Exploitation', 'Networking']
  },
  {
    title: 'Personal Portfolio Website',
    description: 'A personal portfolio website built with Next.js and Tailwind CSS, showcasing projects, skills, and experience. The site features a responsive design, smooth animations, and a clean user interface to effectively present my work and background.',
    imageURL: '/portfolio1.png',
    github: 'https://github.com/ton-username/portfolio',
    live: 'https://ton-username.github.io/portfolio',
    //blog: 'https://dev.to/ton-username/building-my-personal-portfolio-with-nextjs-and-tailwindcss-1h2o',
    tags: ['Next.js', 'Tailwind CSS', 'React', 'Web Development', 'Portfolio']
  },
  {
    title: 'Arcade Game Program',
    description: 'A collection of classic arcade games (Snake, Nibler) developed in C++ using the SFML and SDL libraries. The project focuses on game development principles, including graphics rendering, user input handling, and game logic implementation.',
    imageURL: '/arcade.jpg',
    github: 'https://github.com/kouadinouzacharie',
    live: '',
    tags: ['C++', 'Game Development', 'SFML', 'SDL', 'Arcade Games']

  },
  {
    title: 'A-Maze-D',
    description: 'A maze generation and solving program implemented in C. The project includes algorithms for creating random mazes and finding paths through them, demonstrating concepts in graph theory and algorithm design.',
    imageURL: '/amaze-d.jpg',
    github: '',
    live: '',
    tags: ['C', 'Labyrinth', 'Pathfinding', 'Algorithm']
           ...
           return (
             <div key={project.title} className={`relative ${isColSpan2(i) ? 'md:col-span-2' : ''}`}>
               <BentoGridItem
                 ...
                 header={
                   <div className="relative w-full h-50 [@media(max-width:425px)]:min-h-[10rem] min-h-[6rem] rounded-xl overflow-hidden">
                     <Image
