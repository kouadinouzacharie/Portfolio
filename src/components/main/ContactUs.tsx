            ...
            >
              ...
              <div className="space-y-5 text-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">kouadinouzacharie@gmail.com</span>
                  <button
                    title="Copy email address"
                    onClick={() => copyToClipboard('kouadinouzacharie@gmail.com', 'Email')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">+229 0146047020</span>
                  <button
                    title="Copy phone number"
                    onClick={() => copyToClipboard('+229 0146047020', 'Phone number')}
                    className="text-muted-foreground hover:text-primary transition"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">Cotonou, Benin</span>
                </div>
              </div>
            </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5" aria-label="Contact Form">
                  ...
                  >
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 bg-background/50 text-foreground rounded-lg border-2 border-gray-500 focus:outline-none  placeholder-muted-foreground transition-all"
                        required
                        aria-label={field}
                      />
                    </div>
                ...
                <motion.div custom={3} variants={inputVariants} initial="hidden" animate="visible">
                  <textarea
                    ...
                    className="w-full pl-4 pr-4 py-3 bg-background/50 text-foreground rounded-lg border-2 border-gray-500 h-36 resize-none focus:outline-none placeholder-muted-foreground transition-all"
                    required
                    aria-label="Message"
                  />
                </motion.div>
