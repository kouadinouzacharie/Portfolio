  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative bg-card/40 backdrop-blur-sm border border-primary/20 rounded-2xl p-6 shadow-2xl">
            <h2 title="DevOps & Cloud Engineer" className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary via-blue-500 to-primary bg-clip-text text-transparent mb-3">
              Backend Developer & Cybersecurity Analyst - Network & Systems (Junior) 
            </h2>
        ...
        >
          Security-first backend developer and cybersecurity analyst with a passion for building secure, scalable applications and protecting digital assets. Dedicated to continuous learning and staying ahead of emerging threats in the cybersecurity landscape.
        </motion.p>
      </motion.div>
