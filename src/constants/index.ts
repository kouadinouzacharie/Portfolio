...
export const skills: Skill[] = [
  { skill_name: 'C', Image: '/c.png', width: 70, height: 70, color: '#0000FF' },
  { skill_name: 'C++', Image: '/cplusplus.png', width: 70, height: 70, color: '#0000FF' },
  ...
  { skill_name: 'Supabase', Image: '/supabase.png', width: 70, height: 70 },
